hexo.extend.filter.register('before_generate', () => {
  const defaultConfig = {
    ...
    hometop: {
      ...
      banner: {
        title: 'Eureka',
        url: 'A simple theme based on Solitude.',
        icon: null,
      },
      group: null,
      recommendList: {
    ...
    aside: {
      ...
      card: {
        ...
        background: null,
        content1: 'Eureka',
        content2: 'A simple theme based on Solitude.',
        sayhello: {
        ...
        sayhello2: ['Welcome to Eureka', 'A simple theme based on Solitude', 'Enjoy your time', 'Have a nice day', 'Good luck'],
        information: null,
      },
      flip: {
        favicon: '',
